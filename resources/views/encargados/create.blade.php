...
@section('content_header')
    <h1 class="font-bold"><i class="fas fa-users"></i>&nbsp;Crear nuevo encargado</h1>
@stop
    ...
    <div class="container bg-gray-300 shadow-lg rounded-lg">
        <div class="row p-4 rounded-b-none rounded-t-lg shadow-xl bg-white">
            <h5 class="card-title p-2">
                <i class="fas fa-edit"></i>&nbsp; Ingresar informacion del encargado
            </h5>
        </div>
        @method('PUT')
        @csrf
        {!! Form::open(['method'=>'POST','route'=>['encargados.store']]) !!}
