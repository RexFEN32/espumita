...
@section('content_header')
    <h1 class="font-bold"><i class="fas fa-users"></i>&nbsp;Editar Informacion del Vendedor de Mostrador</h1>
@stop
    ...
    <div class="container bg-gray-300 shadow-lg rounded-lg">
        <div class="row p-4 rounded-b-none rounded-t-lg shadow-xl bg-white">
            <h5 class="card-title p-2">
                <i class="fas fa-edit"></i>&nbsp; Editar informacion del vendedor de Mostrador
            </h5>
        </div>
        {!! Form::open(['method'=>'PUT','route'=>['usuarios.update',$usuarios->id]]) !!}
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <x-jet-input type="text" name="porcentaje" class="w-full text-xs " value="{{ $usuarios->porcentaje }}"/>
